...
class Node:
    ...
    def __init__(self, key):
        ...
        end_time = (raw_sched_time + timedelta(minutes = int(duration)))
        self.data = key
...
class BSTDemo:
    ...
    def _insert(self, curr, key):
        if key.data > curr.data and key.scheduled_end >= curr.scheduled_end:
            if curr.right_child == None:
                curr.right_child = key
                self.helpful_print(key, True)
            else:
                self._insert(curr.right_child, key)
        elif key.data < curr.data and key.scheduled_end <= curr.scheduled_end:
        ...
        if curr:
            if key == curr.data:
                ...
                if curr.left_child and curr.right_child:
                    ...
                    curr.data = min_child.data #copies to parent
                    self._delete_val(curr.right_child, curr, False, min_child.data) #delete current value wich is the copy, while saving rightchild data
